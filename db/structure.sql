...
--
-- Name: manure_approach_applications; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE manure_approach_applications (
    id integer NOT NULL,
    supply_nature character varying,
    parameters jsonb,
    results jsonb,
...
--
-- Name: manure_approach_applications_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE manure_approach_applications_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: manure_approach_applications_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE manure_approach_applications_id_seq OWNED BY manure_approach_applications.id;


--
-- Name: manure_management_plan_animal_balances; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE manure_management_plan_animal_balances (
    id integer NOT NULL,
    plan_id integer NOT NULL,
    animal_group_id integer NOT NULL,
    population numeric(19,4),
    large_stock_unit_population numeric(19,4),
    inside_building_attendance_percentage numeric(19,4),
...
--
-- Name: manure_management_plan_animal_balances_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE manure_management_plan_animal_balances_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: manure_management_plan_animal_balances_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE manure_management_plan_animal_balances_id_seq OWNED BY manure_management_plan_animal_balances.id;


--
-- Name: manure_management_plan_intervention_targets; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE manure_management_plan_intervention_targets (
    id integer NOT NULL,
    manuring_zone_id integer NOT NULL,
    manuring_intervention_id integer NOT NULL,
    spreading_zone postgis.geometry(Geometry,4326),
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    creator_id integer,
    updater_id integer,
...
--
-- Name: manure_management_plan_intervention_targets_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE manure_management_plan_intervention_targets_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: manure_management_plan_intervention_targets_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE manure_management_plan_intervention_targets_id_seq OWNED BY manure_management_plan_intervention_targets.id;


--
-- Name: manure_management_plan_interventions; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE manure_management_plan_interventions (
    id integer NOT NULL,
    name character varying NOT NULL,
    procedure_name character varying NOT NULL,
    actions character varying,
...
--
-- Name: manure_management_plan_interventions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE manure_management_plan_interventions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: manure_management_plan_interventions_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE manure_management_plan_interventions_id_seq OWNED BY manure_management_plan_interventions.id;


--
-- Name: manure_management_plan_natures; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE manure_management_plan_natures (
    id integer NOT NULL,
    supply_nature character varying,
...
--
-- Name: manure_management_plan_natures_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE manure_management_plan_natures_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: manure_management_plan_natures_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE manure_management_plan_natures_id_seq OWNED BY manure_management_plan_natures.id;
...
CREATE TABLE manure_management_plans (
    ...
    updater_id integer,
    lock_version integer DEFAULT 0 NOT NULL,
    data_unit character varying,
    milk_annual_production_in_liter integer,
    external_building_attendance_in_month numeric(19,4)
);
...
--
-- Name: manure_approach_applications id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY manure_approach_applications ALTER COLUMN id SET DEFAULT nextval('manure_approach_applications_id_seq'::regclass);


--
-- Name: manure_management_plan_animal_balances id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY manure_management_plan_animal_balances ALTER COLUMN id SET DEFAULT nextval('manure_management_plan_animal_balances_id_seq'::regclass);


--
-- Name: manure_management_plan_intervention_targets id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY manure_management_plan_intervention_targets ALTER COLUMN id SET DEFAULT nextval('manure_management_plan_intervention_targets_id_seq'::regclass);


--
-- Name: manure_management_plan_interventions id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY manure_management_plan_interventions ALTER COLUMN id SET DEFAULT nextval('manure_management_plan_interventions_id_seq'::regclass);


--
-- Name: manure_management_plan_natures id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY manure_management_plan_natures ALTER COLUMN id SET DEFAULT nextval('manure_management_plan_natures_id_seq'::regclass);
...
--
-- Name: manure_approach_applications manure_approach_applications_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY manure_approach_applications
    ADD CONSTRAINT manure_approach_applications_pkey PRIMARY KEY (id);


--
-- Name: manure_management_plan_animal_balances manure_management_plan_animal_balances_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY manure_management_plan_animal_balances
    ADD CONSTRAINT manure_management_plan_animal_balances_pkey PRIMARY KEY (id);


--
-- Name: manure_management_plan_intervention_targets manure_management_plan_intervention_targets_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY manure_management_plan_intervention_targets
    ADD CONSTRAINT manure_management_plan_intervention_targets_pkey PRIMARY KEY (id);


--
-- Name: manure_management_plan_interventions manure_management_plan_interventions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY manure_management_plan_interventions
    ADD CONSTRAINT manure_management_plan_interventions_pkey PRIMARY KEY (id);


--
-- Name: manure_management_plan_natures manure_management_plan_natures_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY manure_management_plan_natures
    ADD CONSTRAINT manure_management_plan_natures_pkey PRIMARY KEY (id);
...
--
-- Name: index_manure_animal_balance_animal_group; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_animal_balance_animal_group ON manure_management_plan_animal_balances USING btree (animal_group_id);


--
-- Name: index_manure_animal_balance_plan; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_animal_balance_plan ON manure_management_plan_animal_balances USING btree (plan_id);


--
-- Name: index_manure_approach_application_on_manure_plan_nature; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_approach_application_on_manure_plan_nature ON manure_approach_applications USING btree (manure_management_plan_nature_id);


--
-- Name: index_manure_intervention_plan; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_intervention_plan ON manure_management_plan_interventions USING btree (plan_id);


--
-- Name: index_manure_intervention_target_intervention; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_intervention_target_intervention ON manure_management_plan_intervention_targets USING btree (manuring_intervention_id);


--
-- Name: index_manure_intervention_target_zone; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_intervention_target_zone ON manure_management_plan_intervention_targets USING btree (manuring_zone_id);


--
-- Name: index_manure_intervention_variant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_intervention_variant ON manure_management_plan_interventions USING btree (variant_id);


--
-- Name: index_manure_management_plan_animal_balances_on_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_management_plan_animal_balances_on_created_at ON manure_management_plan_animal_balances USING btree (created_at);


--
-- Name: index_manure_management_plan_animal_balances_on_creator_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_management_plan_animal_balances_on_creator_id ON manure_management_plan_animal_balances USING btree (creator_id);


--
-- Name: index_manure_management_plan_animal_balances_on_updated_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_management_plan_animal_balances_on_updated_at ON manure_management_plan_animal_balances USING btree (updated_at);


--
-- Name: index_manure_management_plan_animal_balances_on_updater_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_management_plan_animal_balances_on_updater_id ON manure_management_plan_animal_balances USING btree (updater_id);


--
-- Name: index_manure_management_plan_intervention_targets_on_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_management_plan_intervention_targets_on_created_at ON manure_management_plan_intervention_targets USING btree (created_at);


--
-- Name: index_manure_management_plan_intervention_targets_on_creator_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_management_plan_intervention_targets_on_creator_id ON manure_management_plan_intervention_targets USING btree (creator_id);


--
-- Name: index_manure_management_plan_intervention_targets_on_updated_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_management_plan_intervention_targets_on_updated_at ON manure_management_plan_intervention_targets USING btree (updated_at);


--
-- Name: index_manure_management_plan_intervention_targets_on_updater_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_management_plan_intervention_targets_on_updater_id ON manure_management_plan_intervention_targets USING btree (updater_id);


--
-- Name: index_manure_management_plan_interventions_on_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_management_plan_interventions_on_created_at ON manure_management_plan_interventions USING btree (created_at);


--
-- Name: index_manure_management_plan_interventions_on_creator_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_management_plan_interventions_on_creator_id ON manure_management_plan_interventions USING btree (creator_id);


--
-- Name: index_manure_management_plan_interventions_on_updated_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_management_plan_interventions_on_updated_at ON manure_management_plan_interventions USING btree (updated_at);


--
-- Name: index_manure_management_plan_interventions_on_updater_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_management_plan_interventions_on_updater_id ON manure_management_plan_interventions USING btree (updater_id);
...
--
-- Name: index_manure_plan_approach_on_approach; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_plan_approach_on_approach ON manure_approach_applications USING btree (approach_id);


--
-- Name: index_manure_plan_approach_on_manure_plan_zone; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_plan_approach_on_manure_plan_zone ON manure_approach_applications USING btree (manure_management_plan_zone_id);


--
-- Name: index_manure_plan_nature_on_manure_plan; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_manure_plan_nature_on_manure_plan ON manure_management_plan_natures USING btree (manure_management_plan_id);
...
INSERT INTO schema_migrations (version) VALUES ('20160713113304');
...
INSERT INTO schema_migrations (version) VALUES ('20160726115401');
...
INSERT INTO schema_migrations (version) VALUES ('20160727101029');
...
INSERT INTO schema_migrations (version) VALUES ('20160810084131');

INSERT INTO schema_migrations (version) VALUES ('20160812164101');

INSERT INTO schema_migrations (version) VALUES ('20160817133216');

INSERT INTO schema_migrations (version) VALUES ('20160817135601');
